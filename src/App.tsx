        ...
        <AnimatePresence mode="wait">
          {activeTab === 'signin' ? (
            ...
            >
              ...
              {/* Google Sign-In */}
              <form onSubmit={(e) => handleGoogleAuth(e, false)} className="space-y-4">
                <Button
                  variant="outline"
              ...
              <form onSubmit={handleEmailSignIn} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-white dark:text-gray-200 text-sm sm:text-base">
                    Email
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="password" className="text-white dark:text-gray-200 text-sm sm:text-base">
                    Password
                  </Label>
                  <div className="relative">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="terms" className="text-sm text-zinc-300 dark:text-gray-400">
                    I agree to the{' '}
                    <a
                      href="/terms"
            ...
            >
              ...
              {/* Google Sign-Up */}
              <form onSubmit={(e) => handleGoogleAuth(e, true)} className="space-y-4">
                <Button
                  variant="outline"
                  className="w-full bg-transparent border-zinc-700 dark:border-gray-600 text-white dark:text-gray-200 hover:bg-zinc-800/50 dark:hover:bg-gray-700/50 py-6 text-sm sm:text-base transition-all duration-200"
                  disabled={isLoading}
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="username" className="text-white dark:text-gray-200 text-sm sm:text-base">
                    Username
                  </Label>
                  <div className="relative">
